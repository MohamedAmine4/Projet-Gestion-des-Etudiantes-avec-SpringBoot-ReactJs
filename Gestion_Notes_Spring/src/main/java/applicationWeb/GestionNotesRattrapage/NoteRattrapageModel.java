...
@Entity
@Table(name = "NoteRattrapage", uniqueConstraints = {@UniqueConstraint(columnNames = {"cin", "codeMod"})})
public class NoteRattrapageModel {
...
//-------------------------------------------------------------------------------
	...
	public boolean isEtudiantDansNoteRattrapage() {
		return etudiantDansNoteRattrapage;
	}
