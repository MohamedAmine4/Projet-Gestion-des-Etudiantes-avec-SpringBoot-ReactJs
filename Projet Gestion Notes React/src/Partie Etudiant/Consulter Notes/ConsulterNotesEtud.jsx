...
const getResult = useCallback((average) => {
 ...
 //--------------------------------------------------------------------------------------------------------
  ...
  },  [ selectedSession, selectedModule, moyennes, calculateAverage, getResult]);  // updateNoteRattrapage , moyennes , selectedSession , notes
//---------------------------------------------------------------------------------------------------------------
...
<div className='row '>
          <table className='table table-striped table-bordered'>
             ...
             <tbody>
    {notesModules
          .filter((note) => note.module.codeMod === selectedModule && note.session===selectedSession && note.etudiant.cin === cinEtud ) // Filtrer les notes par module et session sélectionnée
          .map((note) => (
